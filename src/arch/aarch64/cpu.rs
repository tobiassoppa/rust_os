...
/// #Safety
///
/// - The HW stae of EL1 must be prepared in a sound way.
/// - Exception return from EL2 must continue execution in EL1 with
///   `runtime_init::runtime_init()`.
#[inline(always)]
unsafe fn el2_to_el1_transition() -> ! {
    use crate::runtime_init;

    // Enable time counter register for EL1
    ...
    //
    // First, fake a saved program status where all interrupts were masked and SP_EL1
